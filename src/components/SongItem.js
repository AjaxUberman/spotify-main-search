  ...
  return (
    <div className="">
      ...
      >
        ...
        <FaCirclePlay
          onClick={updateCurrent}
          className=" opacity-0 group-hover:opacity-100 duration-200 transition ease-in group-hover:-translate-y-24  md:text-5xl text-3xl absolute right-6 -bottom-4 text-primarygreen bg-black rounded-full"
        />
      </div>
    </div>
  );
